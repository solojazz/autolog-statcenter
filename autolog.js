...
if (msg.content.startsWith(prefix + "gender")){
  ...
  let genders = [
    ...
    ['Agenderfluid', 'Agender as "base" gender but experiences fluid/fluxing gender feelings in tandem with their emotions. These gender feelings may confuse or upset the individual and cause their emotional state to go haywire, which causes more gender changes. Also known as *cancegender*.'],
    ...
    ['Amogender', 'A gender where your primary interaction with gender feelings is that of flirtateousness either with gender, or people/the outside world. Also known as *flirtgender*.'],
    ...
    ['Anvisgender', 'A feeling of apathy toward one’s gender that causes one to have no desire to look further into it. Also known as *apagender*.'],
    ...
    ['Arifluid', 'Switching between nonbinary genders while feeling particularly associated with one feeling. Also known as *arigender*.'],
    ...
    ['Batgender', 'A gender that feels more intense during the night, but weak/nonexistent when it is light out. Also known as *nocturnalgender*.'],
    ...
    ['Bordergender/Borderfluid', 'A fluctuating gender experienced exclusively by people with BPD. A gender identity lacking a firm grasp on one’s identity, while still experiencing gender, to varying degrees, but having trouble pinning it down to just one label or identity. Having the sense of grasping at labels as much as possible to describe a gender, one keeps questioning because one keeps second guessing one’s sense of self and consequently, one’s sense of gender. Can be combined with relevant genders.'],
    ...
    ['Burstgender', 'A mostly undefined gender with intense momentary spikes of a specific gender, such as boy, girl, or genderqueer, that last a relatively short time and fade away. Also known as *spikegender*.'],
    ...
    ['Diurnalgender', 'A gender that is more strongly felt during the daytime than at night. Also known as *flowergender*.'],
    ...
    ['Egender', 'An outright refusal to accept or identify in, on, or around the gender spectrum. Also known as *exgender*.'],
    ...
    ['Endogender', 'Having fluctuating or fluid gender feelings that are limited to a certain area of gender, such as masculine, feminine, or neutral. Also known as *femfluid*, *mascfluid*, *nobifluid* and variations thereof. Related to *genderfluid*, *genderflux*, *horogender*.'],
    ...
    ['Femgender', 'A non-binary gender which is primarily feminine in nature. Do not use *femme* gender unless you are a lesbian, as otherwise it is appropriative of lesbian culture.'],
    ...
    ['Genderamas', 'A gender where your primary interaction with gender feelings is that of flirtateousness either with gender, or people/the outside world. Also known as *flirtgender*.'],
    ...
    ['Genderflow', 'A gender which is fluid between infinite feelings. Sometimes, these feelings may be close to an existing term, and sometimes they are indescribable or abstract. Also known as *aquarigender*.'],
    ...
    ['Inersgender', 'A feeling of apathy toward one’s gender that causes one to have no desire to look further into it. Also known as *apagender*.'],
    ...
    ['Lethargender', 'A feeling of apathy toward one’s gender that causes one to have no desire to look further into it. Also known as *apagender*.'],
    ...
    ['Maringender', 'A term to describe when part of one’s gender is unidentifiable. Also known as *nubilagender*.'],
    ['Marfluid', 'Having fluctuating or fluid gender feelings that are limited to masculine genders. Subset of *endogender*, also known as *mascfluid*.'],
    ...
    ['Moongender', 'A gender that feels more intense during the night, but weak/nonexistent when it is light out. Also known as *nocturnalgender*.'],
    ...
    ['Nanogender', 'Feeling a small part one gender, with the rest being something else, ex. nanoboy, nanogirl, etc. The "something else" may or may not be known.'],
    ...
    ['Nocturnalgender', 'A gender that feels more intense during the night, but weak/nonexistent when it is light out. Also known as *batgender*, *owlgender* and *moongender*.'],
    ...
    ['Owlgender', 'A gender that feels more intense during the night, but weak/nonexistent when it is light out. Also known as *nocturnalgender*.'],
    ...
    ['Portiogender', 'A gender composed of pieces or fractions of many genders and feelings. Also known as *mosaigender*.'],
    ...
    ['Swampgender', 'A gender that feels like a bog, swamp, marsh or similar ecosystem. Also known as *boggender*.'],
    ...
    ['Ungender', 'A gender which can only be described as the opposite of another gender, eg. an antiboy being the opposite of a boy. Also known as *antigender*.'],
    ...
    ['Venufluid', 'Having fluctuating or fluid gender feelings that are limited to feminine genders. Subset of *endogender*, also known as *femfluid*.'],
    ...
    ['Xumgender', 'Never being satisfied with your gender due to constant self-doubt or identity issues, causing one to compulsively search and seek out something that fits as perfect as possible – to find *"the gender"* or *"the one truth"* – though one will never be found due to one’s neurotype, because words will never be able to describe it, and/or its own properties paradox itself. This frequent anxiety and doubt causes even this gender to feel imperfect to the individual.'],
